package com.apps.gerdjes.myfirstandroidapplication;
...
import static com.apps.gerdjes.myfirstandroidapplication.R.attr.height;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_compute.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String weight = edit_height.getText().toString();
